...
class HashMap(object):
    ...
    def __init__(self, capacity=8):
        ...
        self._size = 0 #broj elem u tabeli
    ...
    def _hash(self, x):
        ...
        """
        hashed_value = (hash(x)*self._a + self._b) % self.prime #MAD - osigurava dobar raspored elemenata, lepa raspodela
    ...
    def __setitem__(self, key, value):
        ...
        # povećaj broj raspoloživih mesta - ovim obezbedjujemo konstantno malu popunjenost mape i O(1) slozenost operacija
...
class LinearHashMap(HashMap):
    ...
    def _find_bucket(self, bucket_index, key, check_deleted=False):
        ...
        """
        available_slot = None   #ako je neuspesna pretraga, prvo slobodno mesto na koje mozemo da upisemo elem
        while True:
            if self._is_available(bucket_index):
                ...
                return True, bucket_index #uspesna pretraga

            bucket_index = (bucket_index+1) % len(self._data) #CIRKULARNO OBILAZENJE
